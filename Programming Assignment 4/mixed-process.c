/*
 *  CSCI3753 PA4 Adam Holt & Joe Cosenza
 * 	This file contains a program to copy N bytes from an input file to an 
 *  output file for specific scheduling policy and number of processes to benchmark i/o bound processes
 *  as well as a program to calculate PI resulting in a combination of i/o and cpu bound processes
 */

 ...
 * 	This file contains a small i/o bound program to copy N bytes from an input
 *              file to an output file for specific scheduling policy and number of processes to benchmark i/o bound processes
 */
